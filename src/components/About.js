...
import biologo1 from '../images/about-us-image.png'
      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-7 about-right">
            ...
            <p className="p-first text-white">
              When I started college I originally had the idea of going into animation. I still carried that idea at the back of my mind that I needed to prove myself. To let people know I can do anything I set my mind to. So I decided to study Engineering, like understanding Calculus and Quantum Mechanics made me Super-Human. After building my first website with some few Youtube tutorials on Wordpress, and getting instant gratification of praise from others, I was hooked. The internet was my outlet. A new way to show and share my passions. I eventually left Web Design in pursuit of a steady income and I got into Banking, working hard to make sure all my Customers had value for their money. I honed skills in Customer Service and Leadership. After 4yrs in Banking, I decided to go back to my first Love (well, more like second or third love) and enrolled in a Full Stack Web Development Program with Lambda School.</p>
